(function(){const staticCacheName='static';const version='v1::';const OFFLINE_URL='https://hugoinaction.github.io/off/';function updateStaticCache(){const urls=['https://hugoinaction.github.io/','https://hugoinaction.github.io/manifest.json','/GithubPages/css/index.min.645dfbe45d4d212e881d0ab25cf0ce25d1c91c7dc6a884ea7162c4da1462e34af6275a264779bc2eebd78c2749478203a63019b4e7100883810106b39916e407.css','/GithubPages/index.min.js','https://hugoinaction.github.io/GithubPages/image/background.svg','https://hugoinaction.github.io/GithubPages/image/background-dark_huacd336bfb7f5597695f9c32d4115a2aa_1561823_1400x787_fill_q75_box_smart1.jpg',OFFLINE_URL,'https://hugoinaction.github.io/GithubPages/image/logo.min.svg','https://hugoinaction.github.io/index.json'];return caches.open(version+staticCacheName).then((cache)=>cache.addAll(urls)).catch(e=>{console.log("Error = ",e);console.log(e.stack);});}
